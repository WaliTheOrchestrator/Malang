...
- [ ] **M0 — Measure (1.5d):** TTFT · **live cache-minimum check (Haiku/Sonnet — Block 1 must cross it)** · Kokoro RTF ✅ (P-2 PASS 2026-07-30: p50 0.529 mains / 0.555 battery) + int8 ear check ✅ (P-4a 2026-08-06: negative control failed twice → ship fp32; selective-int8 kept, revisit at P-5; names 9/9) · STT bake-off ✅ (P-3 first-pass 2026-08-02: whisper-turbo dominates → whisper-swap pending M7 runtime check; Moonshine live WER ≫12% → recalibrate; FR-18 lexicon confirmed essential) · WASAPI probe ✅ (P-4b 2026-08-06: 40.0ms mains+battery ≤50ms CONFIRMED, built-in speaker) · **P-5 sustained 10-min duplex load w/ core-class logging, minute-1 vs minute-10, mains + battery** (reversal ladder pre-decided: re-baseline → Supertonic → voice-as-mode) · **P-6 blind voice selection** · battery re-runs. Record all rulings.
