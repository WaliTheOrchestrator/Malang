...
**Spec version:** 1.1 · **Status:** draft (both pre-approval research items resolved by docs-researcher 2026-08-03; spec-guardian BLOCKING B-1 fixed — ready for owner approval)
